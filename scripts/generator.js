...
discone.innerHTML = `I'm a Full-Stack Developer covering ${experience} years experience<br />with high coding skills and passion. I create amazing websites,<br />mobile apps, and interactive applications that bring ideas to life.`;
experienceinfo.innerHTML = `<strong>Experience:</strong> ${experience} years`;
